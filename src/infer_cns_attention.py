...
from unet_cns_attention import UNet
...
# single: CUDA_VISIBLE_DEVICES=3 python infer_cns.py --model_dir=../experiment_single/experiment_single_0/checkpoint/experiment_5_batch_16/ --batch_size=1 --source_obj=../experiment_single/experiment_single_0/data/cns_test.obj --save_dir ../experiment_single/all_results_5/style_0 --embedding_ids=0
# multiple: CUDA_VISIBLE_DEVICES=2 python infer_cns.py --model_dir=../experiment_multiple/checkpoint/experiment_7_batch_16/ --batch_size=1 --source_obj=../experiment_multiple/data/cns_test_style_0.obj --save_dir ../experiment_multiple/results_7/style_0 --embedding_ids=0
